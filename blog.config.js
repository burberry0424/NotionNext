// 注: process.env.XX是Vercel的环境变量，配置方式见：https://www.52112356.xyz/
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.52112356.xyz/
  NOTION_PAGE_ID:
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '嘿嘿以嘿嘿', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '嘿嘿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://52112356.xyz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'heiheiyiheihhei', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ww@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'wej', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'fda', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '@fdas', // 你的telegram 地址 例如 https://t.me/tangly_1024
